...
RSpec.describe 'bit_field/type/ws' do
  ...
  before(:all) do
    RgGen.enable(:bit_field, :type, [:ws, :rw])
  end
  ...
  it '出力ポート#value_out/入力ポート#clearを持つ' do
    bit_fields = create_bit_fields do
      ...
      register do
        name 'register_0'
        bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :ws; initial_value 0 }
        bit_field { name 'bit_field_1'; bit_assignment lsb: 8, width: 2; type :ws; initial_value 0 }
        bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4, sequence_size: 2, step: 8; type :ws; initial_value 0 }
      end

      register do
        name 'register_1'
        bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 64; type :ws; initial_value 0 }
      end
    ...
    expect(bit_fields[1]).to have_port(
      :register_block, :clear,
      name: 'i_register_0_bit_field_1_clear', direction: :input, type: :logic, width: 2
    )
    ...
    expect(bit_fields[3]).to have_port(
      :register_block, :clear,
      name: 'i_register_1_bit_field_0_clear', direction: :input, type: :logic, width: 64
    )
    ...
    expect(bit_fields[10]).to have_port(
      :register_block, :clear,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_0_clear',
    ...
    expect(bit_fields[11]).to have_port(
      :register_block, :clear,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_1_clear',
    ...
    expect(bit_fields[12]).to have_port(
      :register_block, :clear,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_2_clear',
    ...
    it 'rggen_bit_fieldをインスタンスするコードを出力する' do
      bit_fields = create_bit_fields do
        ...
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :ws; initial_value 0 }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 16, width: 16; type :ws; initial_value 0xabcd }
        end
        ...
        register do
          name 'register_2'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 8; type :ws; initial_value 0 }
        end
