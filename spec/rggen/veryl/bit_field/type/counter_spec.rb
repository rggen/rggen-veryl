...
RSpec.describe 'bit_field/type/counter' do
  ...
  it 'パラメータ #up_width/#down_width/#wrap_around を持つ' do
    expect(bit_fields[0]).to have_param(
      ...
      name: 'REGISTER_0_BIT_FIELD_0_UP_WIDTH', type: :u32, default: 1
    )
    expect(bit_fields[0]).to have_param(
      :register_block, :down_width,
      name: 'REGISTER_0_BIT_FIELD_0_DOWN_WIDTH', type: :u32, default: 1
    )
    expect(bit_fields[0]).to have_param(
    ...
    expect(bit_fields[2]).to have_param(
      :register_block, :up_width,
      name: 'REGISTER_1_BIT_FIELD_0_UP_WIDTH', type: :u32, default: 1
    )
    expect(bit_fields[2]).to have_param(
      :register_block, :down_width,
      name: 'REGISTER_1_BIT_FIELD_0_DOWN_WIDTH', type: :u32, default: 1
    )
    expect(bit_fields[2]).to have_param(
      :register_block, :wrap_around,
    ...
    expect(bit_fields[4]).to have_param(
      :register_block, :up_width,
      name: 'REGISTER_2_BIT_FIELD_0_UP_WIDTH', type: :u32, default: 1
    )
    expect(bit_fields[4]).to have_param(
      :register_block, :down_width,
      name: 'REGISTER_2_BIT_FIELD_0_DOWN_WIDTH', type: :u32, default: 1
    )
    expect(bit_fields[4]).to have_param(
      :register_block, :wrap_around,
  ...
  it '入力ポート#up/入力ポート#down/出力ポート#countを持つ' do
    expect(bit_fields[0]).to have_port(
      :register_block, :up,
      name: 'i_register_0_bit_field_0_up', direction: :input, type: :logic, width: 'clip_width(REGISTER_0_BIT_FIELD_0_UP_WIDTH)'
    )
    expect(bit_fields[0]).to have_port(
      :register_block, :down,
      name: 'i_register_0_bit_field_0_down', direction: :input, type: :logic, width: 'clip_width(REGISTER_0_BIT_FIELD_0_DOWN_WIDTH)'
    )
    expect(bit_fields[0]).to have_port(
    ...
    expect(bit_fields[1]).to have_port(
      :register_block, :up,
      name: 'i_register_0_bit_field_1_up', direction: :input, type: :logic, width: 'clip_width(REGISTER_0_BIT_FIELD_1_UP_WIDTH)'
    )
    expect(bit_fields[1]).to have_port(
      :register_block, :down,
      name: 'i_register_0_bit_field_1_down', direction: :input, type: :logic, width: 'clip_width(REGISTER_0_BIT_FIELD_1_DOWN_WIDTH)'
    )
    expect(bit_fields[1]).to have_port(
      :register_block, :count,
      name: 'o_register_0_bit_field_1', direction: :output, type: :logic, width: 8
    )

    expect(bit_fields[2]).to have_port(
      :register_block, :up,
      name: 'i_register_1_bit_field_0_up', direction: :input, type: :logic, width: 'clip_width(REGISTER_1_BIT_FIELD_0_UP_WIDTH)',
      array_size: [2]
    )
    expect(bit_fields[2]).to have_port(
      :register_block, :down,
      name: 'i_register_1_bit_field_0_down', direction: :input, type: :logic, width: 'clip_width(REGISTER_1_BIT_FIELD_0_DOWN_WIDTH)',
      array_size: [2]
    )
    expect(bit_fields[2]).to have_port(
      :register_block, :count,
      name: 'o_register_1_bit_field_0', direction: :output, type: :logic, width: 1,
      array_size: [2]
    )

    expect(bit_fields[3]).to have_port(
      :register_block, :up,
      name: 'i_register_1_bit_field_1_up', direction: :input, type: :logic, width: 'clip_width(REGISTER_1_BIT_FIELD_1_UP_WIDTH)',
      array_size: [2]
    )
    expect(bit_fields[3]).to have_port(
      :register_block, :down,
      name: 'i_register_1_bit_field_1_down', direction: :input, type: :logic, width: 'clip_width(REGISTER_1_BIT_FIELD_1_DOWN_WIDTH)',
      array_size: [2]
    )
    expect(bit_fields[3]).to have_port(
      :register_block, :count,
      name: 'o_register_1_bit_field_1', direction: :output, type: :logic, width: 8,
      array_size: [2]
    )
  end
  ...
  context '参照ビットフィールドを持たない場合' do
    ...
    it '入力ポート#clearを持つ' do
      expect(bit_fields[0]).to have_port(
        ...
        name: 'i_register_0_bit_field_0_clear', direction: :input, type: :logic, width: 1
      )

      expect(bit_fields[1]).to have_port(
        :register_block, :clear,
        name: 'i_register_0_bit_field_1_clear', direction: :input, type: :logic, width: 1
      )

      expect(bit_fields[2]).to have_port(
        :register_block, :clear,
        name: 'i_register_1_bit_field_0_clear', direction: :input, type: :logic, width: 1,
        array_size: [2]
      )

      expect(bit_fields[3]).to have_port(
        :register_block, :clear,
        name: 'i_register_1_bit_field_1_clear', direction: :input, type: :logic, width: 1,
        array_size: [2]
      )
    end
  end
  ...
  context '参照ビットフィールドを持つ場合' do
    ...
    it '入力ポート#clearを持たない' do
      expect(bit_fields[4]).to not_have_port(
        :register_block, :clear,
        name: 'i_register_2_bit_field_0_clear', direction: :input, type: :logic, width: 1
      )

      expect(bit_fields[5]).to not_have_port(
        :register_block, :clear,
        name: 'i_register_2_bit_field_1_clear', direction: :input, type: :logic, width: 1
      )
    end
  end
