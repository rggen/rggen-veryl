...
RSpec.describe 'bit_field/type/w0c' do
  ...
  it '入力ポート#set/出力ポート#value_outを持つ' do
    bit_fields = create_bit_fields do
      ...
      register do
        name 'register_0'
        bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :w0c; initial_value 0 }
        bit_field { name 'bit_field_1'; bit_assignment lsb: 8, width: 2; type :w0c; initial_value 0 }
        bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4, sequence_size: 2, step: 8; type :w0c; initial_value 0 }
      end

      register do
        name 'register_1'
        bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 64; type :w0c; initial_value 0 }
      end
    ...
    expect(bit_fields[1]).to have_port(
      :register_block, :set,
      name: 'i_register_0_bit_field_1_set', direction: :input, type: :logic, width: 2
    )
    expect(bit_fields[1]).to have_port(
      :register_block, :value_out,
    ...
    expect(bit_fields[3]).to have_port(
      :register_block, :set,
      name: 'i_register_1_bit_field_0_set', direction: :input, type: :logic, width: 64
    )
    expect(bit_fields[3]).to have_port(
      :register_block, :value_out,
    ...
    expect(bit_fields[10]).to have_port(
      :register_block, :set,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_0_set',
    ...
    expect(bit_fields[11]).to have_port(
      :register_block, :set,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_1_set',
    ...
    expect(bit_fields[12]).to have_port(
      :register_block, :set,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_2_set',
  ...
  context '参照信号を持つ場合' do
    it '出力ポート#value_unmaskedを持つ' do
      bit_fields = create_bit_fields do
        ...
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :w0c; initial_value 0; reference 'register_4.bit_field_0' }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 8, width: 2; type :w0c; initial_value 0; reference 'register_4.bit_field_1' }
          bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4, sequence_size: 2, step: 8; type :w0c; initial_value 0; reference 'register_4.bit_field_2' }
        end
      ...
      expect(bit_fields[0]).to have_port(
        ...
        name: 'o_register_0_bit_field_0_unmasked', direction: :output, type: :logic, width: 1
      )

      expect(bit_fields[1]).to have_port(
        :register_block, :value_unmasked,
        name: 'o_register_0_bit_field_1_unmasked', direction: :output, type: :logic, width: 2
      )
      ...
      expect(bit_fields[9]).to have_port(
        :register_block, :value_unmasked,
        name: 'o_register_file_3_register_file_0_register_0_bit_field_0_unmasked',
        direction: :output, type: :logic, width: 1, array_size: [2, 2, 2, 2]
      )

      expect(bit_fields[10]).to have_port(
        :register_block, :value_unmasked,
        name: 'o_register_file_3_register_file_0_register_0_bit_field_1_unmasked',
        direction: :output, type: :logic, width: 2, array_size: [2, 2, 2, 2]
      )

      expect(bit_fields[11]).to have_port(
        :register_block, :value_unmasked,
        name: 'o_register_file_3_register_file_0_register_0_bit_field_2_unmasked',
        direction: :output, type: :logic, width: 4, array_size: [2, 2, 2, 2, 2]
      )
    end
  end
    ...
    it 'rggen_bit_fieldをインスタンスするコードを生成する' do
      bit_fields = create_bit_fields do
        ...
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :w0c; initial_value 0 }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 1; type :w0c; reference 'register_6.bit_field_0'; initial_value 1 }
          bit_field { name 'bit_field_2'; bit_assignment lsb: 8, width: 8; type :w0c; initial_value 0 }
          bit_field { name 'bit_field_3'; bit_assignment lsb: 16, width: 8; type :w0c; reference 'register_6.bit_field_2'; initial_value 0xab }
        end
        ...
        register do
          name 'register_2'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 8; type :w0c; initial_value 0 }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 4, width: 4, sequence_size: 4, step: 8; type :w0c; reference 'register_6.bit_field_1'; initial_value 0 }
        end
