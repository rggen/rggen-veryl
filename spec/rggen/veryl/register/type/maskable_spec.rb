...
RSpec.describe 'register/type/maskable' do
  ...
  describe '#generate_code' do
    let(:registers) do
      veryl = create_veryl do
        ...
        register do
          ...
          offset_address 0x40
          type :maskable
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 16; type :rw; initial_value 0 }
        end
        ...
        register do
          ...
          offset_address 0x50
          type :maskable
          bit_field { name 'bit_field_0'; bit_assignment lsb: 4, width: 4, sequence_size: 2, step: 8; type :rw; initial_value 0 }
        end
        ...
        register do
          ...
          offset_address 0x70
          type :maskable
          bit_field { name 'bit_field_0'; bit_assignment lsb: 4, width: 4, sequence_size: 2, step: 32; type :rw; initial_value 0 }
        end
    ...
    it 'rggen::rggen_maskable_registerをインスタンスするコードを出力する' do
      ...
      expect(registers[7]).to generate_code(:register, :top_down, <<~'VERYL')
        inst u_register: rggen::rggen_maskable_register #(
          ...
          DATA_WIDTH:     64,
          VALUE_WIDTH:    64,
          VALID_BITS:     64'h000000f0000000f0
        )(
          i_clk:        i_clk,
          i_rst:        i_rst,
