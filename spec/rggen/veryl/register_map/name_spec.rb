...
RSpec.describe 'regiter_map/name' do
  ...
  let(:veryl_keywords) do
    [
      ...
      'export', 'f32', 'f64', 'final', 'for', 'function', 'i32', 'i64', 'if', 'if_reset',
      'import', 'in', 'include', 'initial', 'inout', 'input', 'inside', 'inst', 'interface',
      'let', 'local', 'logic', 'modport', 'module', 'output', 'outside', 'package', 'param',
      'proto', 'pub', 'ref', 'repeat', 'reset', 'reset_async_high', 'reset_async_low',
      'reset_sync_high', 'reset_sync_low', 'return', 'signed', 'step', 'struct', 'switch',
      'tri', 'type', 'u32', 'u64', 'unsafe', 'var'
    ]
  end
