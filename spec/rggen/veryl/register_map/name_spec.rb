...
RSpec.describe 'regiter_map/name' do
  ...
  let(:veryl_keywords) do
    [
      'alias', 'always_comb', 'always_ff', 'assign', 'as', 'bit', 'bool', 'case', 'clock',
      'clock_posedge', 'clock_negedge', 'connect', 'const', 'converse', 'default', 'else',
      'embed', 'enum', 'f32', 'f64', 'false', 'final', 'for', 'function', 'i32', 'i64',
      'if_reset', 'if', 'import', 'include', 'initial', 'inout', 'input', 'inside', 'inst',
      'interface', 'in', 'let', 'logic', 'lsb', 'modport', 'module', 'msb', 'output', 'outside',
      'package', 'param', 'proto', 'pub', 'repeat', 'reset', 'reset_async_high', 'reset_async_low',
      'reset_sync_high', 'reset_sync_low', 'return', 'break', 'same', 'signed', 'step', 'string',
      'struct', 'switch', 'tri', 'true', 'type', 'u32', 'u64', 'union', 'unsafe', 'var',
    ]
  end
